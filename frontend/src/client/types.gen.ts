...
export type CategoriesDeleteCategoryResponse = (unknown);
...
export type DataJobsDownloadTemplateResponse = (unknown);

export type DataJobsDownloadResultFileData = {
    jobId: string;
};

export type DataJobsDownloadResultFileResponse = (unknown);

export type DataJobsDownloadErrorFileData = {
    jobId: string;
};

export type DataJobsDownloadErrorFileResponse = (unknown);
...
export type TransactionsDeleteTransactionResponse = (unknown);

export type TransactionsBatchEnterTransactionsData = {
    requestBody: TransactionBatchEnter;
};

export type TransactionsBatchEnterTransactionsResponse = (unknown);
