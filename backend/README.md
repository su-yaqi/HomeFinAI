...
Start the local development environment with Docker Compose following the root [README](../README.md) and the engineering guide in [../docs/development-guide.md](../docs/development-guide.md).
